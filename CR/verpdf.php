  ...
  if ($descripcion>0){
            ...
            foreach($descripcion as $desc) {
                ...
                if ($k== $totItems){
                    ...
                    if ($tbl==1){
                        $tablaUno .= '<tr>';
                        $tablaUno .= '<td colspan="1" class="bordeizq borderecho centrar" height="'. $AlturaFinal . 'px">'. $desc["Item"] . '</td>';
                        ...
                        $tablaDos .= '<tr>';
                        $tablaDos .= '<td colspan="1" class="bordeizq borderecho centrar" height="'. $AlturaFinal. 'px">'. $desc["Item"] . '</td>';
            ...
            $fechaexp = '';
            $tablaUno.='<tr><td colspan="22" class="centrar bordeizq borderecho " height="220px"></td></tr>';
            $tablaDos.='<tr><td colspan="22" class=" centrar bordeizq borderecho " height="350px"></td></tr>';
        }
...
//$FechaAutoCompe = strftime("%d de %B de %Y", strtotime($datos["FechaAutoCompe"]));
    ...
    <!-- DESCRIPCION MERCANCIAS -->                
                <tr>
                    ...
                    <td colspan="2" class="borderecho centrar">9. <br>Criterio <br>de<br> Origen:</td>
             </tr>
    <!-- DESCRIPCION MERCANCIAS -->
