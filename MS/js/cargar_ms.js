        ...
        "language": {
            ...
            "columns":[
                    ...
                    {"render":           function ( data, type, row ) {
                                            if (estado=='TERMINADO'){
                                                    return ('<a href="mercosur.php?d='+ row.ID + '" >Duplicar</a>');
                                            }else{
                                                    return ('<a href="mercosur.php?ed=1&d=' + row.ID+ '" >Editar</a>');//<button class="editar btn blue"><i class="material-icons">visibility</i></button>
                                            }
                                }},
                    {"render":           function ( data, type, row ) {
